    ...
    <x-auth-card>
        ...
        <form method="POST" action="{{ route('login') }}">
            ...
            <div class="mt-1 grid grid-cols-1 gap-3">
                <div>
                    <a href="{{ route('social.login', 'facebook') }}" class="w-full inline-flex justify-center py-2 px-4 border border-gray-300 rounded-md shadow-sm bg-white text-sm font-medium text-gray-500 hover:bg-gray-50">
